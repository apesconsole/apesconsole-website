...
export default function App() {
  ...
  const gallery = {
    Artattack: [
      ...
      { src: "https://apesconsole.github.io/apesconsole-assets/images/artattack/4.jpeg"},
      ...
      { src: "https://apesconsole.github.io/apesconsole-assets/images/artattack/10.jpeg"},
      ...
      { src: "https://apesconsole.github.io/apesconsole-assets/images/artattack/17.jpeg"},
      ...
      { src: "https://apesconsole.github.io/apesconsole-assets/images/artattack/23.jpeg"},
      ...
      { src: "https://apesconsole.github.io/apesconsole-assets/images/artattack/35.jpeg"},
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      {/* Contact */}
      <section id="contact" className="p-10 scroll-mt-20 bg-gray-800 text-white">
        ...
        <div className="max-w-2xl flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3 mt-2">
            ...
            <a href="https://www.linkedin.com/in/soumitra-nath-207a095a/" className="hover:text-blue-400">
      ...
      {/* Footer */}
      <footer className="p-6 text-sm bg-gray-800 text-white">
        © {new Date().getFullYear()} Ape's Console — All rights reserved. Generated by Chat GPT 
      </footer>
    </div>
  );
}
