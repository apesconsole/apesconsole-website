    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <header className="p-6 flex justify-between items-center shadow-md bg-white sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-semibold tracking-wide">APESCONSOLE</h1>
        </div>
      ...
      <section id="about" className="p-10 bg-gray-100 scroll-mt-20 w-full text-gray-900">
        <div className="flex flex-col md:flex-row gap-8 items-stretch w-full px-4 sm:px-8 lg:px-20">
          ...
          <div className="md:w-2/5 flex items-center justify-center">
            <img
              ...
              className="w-full max-w-sm md:max-w-full h-auto rounded-xl shadow-lg object-cover"
            />
          </div>
      ...
      <section id="contact" className="p-10 scroll-mt-20 bg-gray-800 text-white relative">
        ...
        <div className="flex justify-between items-start">
          ...
          {/* Right: Text Logo (hidden on mobile) */}
          <div className="absolute inset-y-0 right-6 hidden sm:flex items-center">
      ...
      {/* Footer */}
      <footer className="p-4 text-sm bg-gray-900 text-green-400 border-t border-gray-700 font-mono flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-center sm:text-left">
        <span>
